            ...
            <div class="panel">
                <div class="panel-heading bg-primary">
                 <span class="panel-title">
                    <strong>{{$new_loan_category}}</strong>
                </span>
                </div>
                <div class="panel-body pn">
                    ...
                    @endif
                    <div class="row">
                        <form action="{{url('/loancategory/save')}}" class="form-horizontal" method="post" name="frm" id="frm" enctype="multipart/form-data">
                        <div class="col-sm-6">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="khmer_description" id="khmer_description" required>
                                    </div>
                                </div>
