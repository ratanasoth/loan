...
@section('content')
    <div class="panel">
        ...
        <div class="panel-body pn">
            ...
            @endif
            <form action="{{url('/district/search')}}" class="form-horizontal" method="get" name="frm">
                <div class="row">
            ...
            <table class="table table-hover table-bordered" id="tblUser">
                ...
                <tr>
                    <th>
                        <a href="{{url('/district/create')}}"><i class="fa fa-plus-circle text-primary" title="បន្ថែមថ្មី"></i></a>&nbsp;&nbsp;ល.រ
                    </th>
                    <th>លេខកូដ</th>
                ...
                @foreach($districts as $dis)
                          <tr>
                            <td>{{App\Models\Utility::toKh($dis->id)}}</td>
                            <td>{{$dis->code}}</td>
                            <td>{{$dis->name}}</td>
